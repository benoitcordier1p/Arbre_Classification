...
const val URL = "/api/records/1.0/search/?dataset=les-arbres&q=&facet=domanialite&facet=arrondissement&facet=libellefrancais&facet=espece&facet=circonferenceencm&facet=hauteurenm"
interface TreeApi {
